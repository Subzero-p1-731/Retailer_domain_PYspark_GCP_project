...
BQ_PROJECT = "project-43eb9ab2-2f33-4ef4-985"
...
# MySQL Configuration
MYSQL_CONFIG = {
    "url": "jdbc:mysql://136.116.127.215:3306/supplier-db?useSSL=true&allowPublicKeyRetrieval=true",
...
def save_logs_to_bigquery():
    ...
    if log_entries:
        ...
        log_df.write.format("bigquery") \
            ...
            .mode("append") \
            .save()
        print(f"✅ Logs successfully saved in BigQuery for furture analysis")
...
def read_config_file():
    ...
    return df
# Funtion to Move the Existing Files to Archive
def move_existing_files_to_archive(table):
    ...
    for file in existing_files:
        ...
        # Extract Date from file name (products_27022025.json)
...
##--------------------------------------------------------------------------------------------------------------------------------##
# Funtion to Extract Data from MySql and Save to GCS
